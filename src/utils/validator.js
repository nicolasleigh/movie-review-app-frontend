export const validateMovie = (movieInfo) => {
  ...
  // we are checking genres needs be field with string value
  ...
  // we are checking tags needs be field with string value
  for (let tag of tags) {
  ...
  // we are checking cast needs be field with string value
  for (let c of cast) {
